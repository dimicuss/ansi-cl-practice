...
;;   сравнивает только знаки и часла, то при вызове member следует использовать :key #'equal:
...
;;9. Напишите прогорамму, которая ищет наиболее длинный путь в сети содержащей циклы.
