(defun draw-rects (x y a b n) 
  (let ((crAx (- x (/ a 2)))
    ...
    (draw-rects crAx crAy (ceiling a 2) (ceiling b 2))
    (draw-rects crBx crBy (ceiling a 2) (ceiling b 2))
    (draw-rects crCx crCy (ceiling a 2) (ceiling b 2))
    (draw-rects crDx crDy (ceiling a 2) (ceiling b 2))))
    
    
    
(draw-rectangle-* 0 900 900 900)
(draw-cects 0 900 900 900)
